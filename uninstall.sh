...
systemctl disable --now oneplus-badvpn.service oneplus-slowdns.service oneplus-dropbear.service oneplus-websocket.service oneplus-tls.service oneplus-openvpn.service oneplus-mux.service oneplus-firewall.service oneplus-user-maintenance.timer 2>/dev/null || true
...
rm -f /etc/systemd/system/oneplus-badvpn.service /etc/systemd/system/oneplus-slowdns.service \
  ...
  /etc/systemd/system/oneplus-openvpn.service /etc/systemd/system/oneplus-mux.service /etc/systemd/system/oneplus-firewall.service \
