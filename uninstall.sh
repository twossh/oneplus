...
systemctl disable --now oneplus-badvpn.service oneplus-slowdns.service oneplus-dropbear.service oneplus-websocket.service oneplus-tls.service oneplus-openvpn.service oneplus-mux.service oneplus-firewall.service oneplus-user-maintenance.timer oneplus-openvpn-pki-maintenance.timer oneplus-history.timer oneplus-integration-resume.service 2>/dev/null || true
...
rm -f /etc/systemd/system/oneplus-badvpn.service /etc/systemd/system/oneplus-slowdns.service \
  ...
  /etc/systemd/system/oneplus-integration-resume.service
